import svgPaths from "./svg-bldvikvjh7";
...
import { imgGroup, imgGroup1, imgGroup2 } from "./svg-t3940";
...
function Background2() {
  return <div className="bg-[#e5e7eb] border-8 border-solid border-white col-1 ml-0 mt-[20px] row-1 size-[280px]" data-name="Background" />;
}

function Pic2() {
  return (
    <div className="col-1 h-[280px] ml-[20.5px] mt-0 pointer-events-none relative row-1 w-[240px]" data-name="Pic">
      <img alt="" className="absolute inset-0 max-w-none object-cover size-full" src={imgPic} />
      <div aria-hidden="true" className="absolute border-8 border-solid border-white inset-0" />
    </div>
  );
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center not-italic relative shrink-0 w-full" data-name="Content">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[40px] relative shrink-0 text-[#111827] text-[36px]">Hi, I’m Sagar 👋</p>
...
function Background3() {
  return <div className="bg-[#e5e7eb] border-8 border-[#f9fafb] border-solid col-1 h-[360px] ml-0 mt-[20px] row-1 w-[320px]" data-name="Background" />;
}

function Pic3() {
  return (
    <div className="col-1 h-[360px] ml-[20px] mt-0 pointer-events-none relative row-1 w-[280px]" data-name="Pic">
      <img alt="" className="absolute inset-0 max-w-none object-cover size-full" src={imgPic1} />
      <div aria-hidden="true" className="absolute border-8 border-[#f9fafb] border-solid inset-0" />
    </div>
  );
...
function Column31() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic overflow-clip relative shrink-0 w-full" data-name="Column">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.48px] w-full whitespace-pre-wrap">Curious about me? Here you have it:</p>
      <Content3 />
    </div>
  );
}
...
function Container11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-center min-h-px min-w-px overflow-clip relative" data-name="Container">
      <Row34 />
      <Row36 />
    </div>
  );
...
function Row39() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Row">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] max-w-[576px] not-italic relative shrink-0 text-[#4b5563] text-[18px] text-center w-full whitespace-pre-wrap">The skills, tools and technologies I am really good at:</p>
    </div>
  );
}
...
function Tech16() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconJavscript1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Javascript</p>
    </div>
  );
}
...
function Tech17() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconTypescript1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Typescript</p>
    </div>
  );
}
...
function Tech18() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconReact1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">React</p>
    </div>
  );
}
...
function Tech19() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconNextjs1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Next.js</p>
    </div>
  );
}
...
function Tech20() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconNodejs1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Node.js</p>
    </div>
  );
}
...
function Tech21() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconExpress1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Express.js</p>
    </div>
  );
}
...
function Tech22() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconNest1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Nest.js</p>
    </div>
  );
}
...
function Tech23() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconSocket1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Socket.io</p>
    </div>
  );
}
...
function Tech24() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">PostgreSQL</p>
    </div>
  );
}
...
function Tech25() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconMongodb1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">MongoDB</p>
    </div>
  );
}
...
function Tech26() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconSass1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Sass/Scss</p>
    </div>
  );
}
...
function Tech27() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconTailwindcss1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Tailwindcss</p>
    </div>
  );
}
...
function Tech28() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconFigma1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Figma</p>
    </div>
  );
}
...
function Tech29() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconCypress1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Cypress</p>
    </div>
  );
}
...
function Tech30() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconStorybook1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Storybook</p>
    </div>
  );
}
...
function Tech31() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-center justify-center overflow-clip relative shrink-0" data-name="Tech">
      <IconGit1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Git</p>
    </div>
  );
}
...
function Row49() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Row">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] max-w-[576px] not-italic relative shrink-0 text-[#4b5563] text-[18px] text-center w-full whitespace-pre-wrap">Here is a quick summary of my most recent experiences:</p>
    </div>
  );
}
...
function Column36() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-full" data-name="Column">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#111827] text-[18px] w-full whitespace-pre-wrap">Sr. Frontend Developer</p>
      <Column37 />
    </div>
  );
}
...
function Column40() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-full" data-name="Column">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#111827] text-[18px] w-full whitespace-pre-wrap">Team Lead</p>
      <Column41 />
    </div>
  );
}
...
function Column44() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Column">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic relative shrink-0 text-[#111827] text-[18px] w-full whitespace-pre-wrap">Full Stack Developer</p>
      <Column45 />
    </div>
  );
}
...
function Row58() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Row">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] max-w-[576px] not-italic relative shrink-0 text-[#4b5563] text-[18px] text-center w-full whitespace-pre-wrap">Some of the noteworthy projects I have built:</p>
    </div>
  );
}
...
function Picture3() {
  return (
    <div className="flex-[1_0_0] h-[192px] min-h-px min-w-px relative rounded-[12px] shadow-[0px_4px_3px_0px_rgba(0,0,0,0.1),0px_10px_8px_0px_rgba(0,0,0,0.04)]" data-name="Picture">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[12px] size-full" src={imgPicture} />
    </div>
  );
}
...
function Column46() {
  return (
    <div className="bg-[#f9fafb] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="Column">
      ...
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b border-solid inset-0 pointer-events-none rounded-tl-[12px] rounded-tr-[12px]" />
    </div>
  );
}
    ...
    <div className="relative rounded-bl-[12px] rounded-tl-[12px] shrink-0 w-full" data-name="Column">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center p-[32px] relative w-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic overflow-hidden relative shrink-0 text-[#111827] text-[18px] text-ellipsis w-full whitespace-nowrap">Fiskil</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px] w-full whitespace-pre-wrap">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas nec urna ac tellus volutpat viverra. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae.</p>
          <Technologies3 />
          <Actions7 />
        </div>
...
function Row64() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Row">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] max-w-[576px] not-italic relative shrink-0 text-[#4b5563] text-[18px] text-center w-full whitespace-pre-wrap">Nice things people have said about me:</p>
    </div>
  );
}
...
function Email1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-center overflow-clip relative shrink-0" data-name="Email">
      <Icon26 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic relative shrink-0 text-[#111827] text-[18px] text-center tracking-[-0.36px]">reachsagarshah@gmail.com</p>
      <IconButton19 />
    </div>
  );
}
...
function Phone1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-center overflow-clip relative shrink-0" data-name="Phone">
      <Icon28 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic relative shrink-0 text-[#111827] text-[18px] text-center tracking-[-0.36px]">+91 8980500565</p>
      <IconButton20 />
    </div>
  );
}
...
function Footer1() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col items-center justify-center py-[24px] relative shrink-0 w-full" data-name="Footer">
      <Container17 />
    </div>
  );
}
...
function Link4() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Link">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">About</p>
    </div>
  );
}
...
function SwitchTheme() {
  return (
    <div className="content-stretch flex items-center justify-between overflow-clip relative shrink-0 w-full" data-name="Switch Theme">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4b5563] text-[16px]">Switch Theme</p>
      <IconButton25 />
    </div>
  );
}
...
function MobileMenu() {
  return (
    <div className="backdrop-blur-[4px] bg-[rgba(17,24,39,0.1)] content-stretch flex flex-col h-[667px] items-start overflow-clip relative shrink-0 w-[375px]" data-name="Mobile Menu">
      <Menu />
    </div>
  );
}
